...
<body style="font-family:'Georgia',serif;max-width:600px;margin:0 auto;padding:40px 24px;color:#0a0a0a;background:#faf9f7;">
  ...
  <div style="background:#fff;border:1px solid #e8e0d5;border-radius:12px;padding:24px;margin:28px 0;">
    <p style="font-size:11px;font-family:sans-serif;color:#c9a961;text-transform:uppercase;letter-spacing:0.1em;margin:0 0 8px;">Product Required</p>
    <h2 style="font-size:20px;font-weight:bold;color:#0a0a0a;margin:0 0 16px;">${request.title}</h2>
  ...
  <div style="text-align:center;margin:32px 0;">
    <a href="${respondUrl}" style="display:inline-block;background:#c9a961;color:#fff;text-decoration:none;padding:14px 36px;border-radius:10px;font-family:sans-serif;font-size:14px;font-weight:bold;letter-spacing:0.05em;">I Have This Product</a>
  </div>
